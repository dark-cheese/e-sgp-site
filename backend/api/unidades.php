...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        registrarHistorico($conn, 'CRIAR', 'unidade', $insertId, 'Cadastrou nova unidade: ' . $nome);

        echo json_encode(['success' => true, 'message' => 'Unidade cadastrada com sucesso.', 'id' => $insertId]);
    } catch (PDOException $e) {
