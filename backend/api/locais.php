...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        registrarHistorico($conn, 'CRIAR', 'departamento', $insertId, 'Cadastrou novo departamento: ' . $nome);

        echo json_encode(['success' => true, 'message' => 'Departamento cadastrado com sucesso.', 'id' => $insertId]);
    } catch (PDOException $e) {
